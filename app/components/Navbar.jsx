...
export default function Navbar() {
  return (
    <header className="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
      <nav
        className="relative max-w-[85rem] w-full bg-neutral-800 rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto"
        aria-label="Global"
      >
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-end py-2 md:py-0 md:ps-7">
            ...
            <div>
              <Link
                className="group inline-flex items-center gap-x-2 py-2 px-3 bg-blue-900 font-medium text-sm text-white rounded-full focus:outline-none"
                href="#"
              >
                Contact us
              </Link>
